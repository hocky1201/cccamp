			...
			?>
                    ...
                    <div class="col-sm-6">
                        <form method="POST" action="updateact.php" enctype="multipart/form-data">
                            ...
                            <php? echo"<input type='hidden' value='$act_code' name='exeact_code'><br>";?>
                                <span class="input-group-addon">活動名稱</span>
                                <input type="text" class="form-control" name="exeact_name" value="<?php echo $act_name;?>" required autofocus>
                            </div>

                            <div class="input-group">
                                <span class="input-group-addon">活動敘述</span>
                                <textarea class="form-control" rows="5" name="exeact_desc" placeholder="限300字" required><?php echo $act_desc;?></textarea>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control" name="exeact_area">
                            ...
                            <div class="input-group">
                                ...
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="1" <?php if ($act_field == '法政') echo 'checked';?>>法政</label>
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="2" <?php if ($act_field == '財經') echo 'checked';?>>財經</label>
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="3" <?php if ($act_field == '外語') echo 'checked';?>>外語</label>
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="4" <?php if ($act_field == '數理化學') echo 'checked';?>>數理化學</label>
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="5" <?php if ($act_field == '地球與環境') echo 'checked';?>>地球與環境</label>
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="6" <?php if ($act_field == '資訊') echo 'checked';?>>資訊</label>
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="7" <?php if ($act_field == '生物資源') echo 'checked';?>>生物資源</label>
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="8" <?php if ($act_field == '建築') echo 'checked';?>>建築</label>
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="9" <?php if ($act_field == '設計') echo 'checked';?>>設計</label>
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="10" <?php if ($act_field == '藝術') echo 'checked';?>>藝術</label>
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="11" <?php if ($act_field == '社會與心理') echo 'checked';?>>社會與心理</label>
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="12" <?php if ($act_field == '大眾傳播') echo 'checked';?>>大眾傳播</label>
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="13" <?php if ($act_field == '文史哲') echo 'checked';?>>文史哲</label>
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="14" <?php if ($act_field == '教育') echo 'checked';?>>教育</label>
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="15" <?php if ($act_field == '管理') echo 'checked';?>>管理</label>
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="16" <?php if ($act_field == '運動遊憩') echo 'checked';?>>運動遊憩</label>
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="17" <?php if ($act_field == '工程') echo 'checked';?>>工程</label>
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="18" <?php if ($act_field == '機器人') echo 'checked';?>>機器人</label>
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="19" <?php if ($act_field == '生命科學') echo 'checked';?>>生命科學</label>
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="20" <?php if ($act_field == '醫藥衛生') echo 'checked';?>>醫藥衛生</label>
                                <label class="radio-inline"><input type="radio" name="exeact_field" vaLue="21" <?php if ($act_field == '其他') echo 'checked';?>>其他</label>
                            </div>
                            
                            <div class="input-group">
                                <span class="input-group-addon">報名費用</span>
                                <input type="number" class="form-control" name="exeact_price" value="<?php echo $act_price;?>"required >
                            </div>

                            <div class="input-group">
                                <span class="input-group-addon">開放學齡</span>
                                <div class="checkbox">
                                    <label><input type="checkbox" name="exeact_stage1" vaLue="幼稚園" <?php if($act_stage1 != NULL) echo 'checked';?>>幼稚園</label>
                                    <label><input type="checkbox" name="exeact_stage2" vaLue="國小" <?php if($act_stage2 != NULL) echo 'checked';?>>國小</label>
                                    <label><input type="checkbox" name="exeact_stage3" vaLue="國中" <?php if($act_stage3 != NULL) echo 'checked';?>>國中</label>
                                    <label><input type="checkbox" name="exeact_stage4" vaLue="高中" <?php if($act_stage4 != NULL) echo 'checked';?>>高中</label>
                                    <label><input type="checkbox" name="exeact_stage5" vaLue="高職" <?php if($act_stage5 != NULL) echo 'checked';?>>高職</label>
                                    <label><input type="checkbox" name="exeact_stage6" vaLue="大專院校" <?php if($act_stage6 != NULL) echo 'checked';?>>大專院校</label><br>
                                    <label><input type="checkbox" name="exeact_stage7" vaLue="研究所" <?php if($act_stage7 != NULL) echo 'checked';?>>研究所</label>
                                    <label><input type="checkbox" name="exeact_stage8" vaLue="社會人士" <?php if($act_stage8 != NULL) echo 'checked';?>>社會人士</label>
                                </div>
                            </div>

                            <div class="input-group">
                                <span class="input-group-addon">海報圖片</span>
                                <input type="text" class="form-control" name="exeact_poster" placeholder="請提供圖片網址" value="<?php echo $act_poster;?>" required>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="exeact_ORG" value="<?php echo $org;?>"required>
                            </div>

                            <div class="input-group">
                                <span class="input-group-addon">聯絡人稱呼</span>
                                <input type="text" class="form-control" name="exeact_PICname" value="<?php echo $act_PICname;?>" required>
                            </div>

                            <div class="input-group">
                                <span class="input-group-addon">聯絡人電話</span>
                                <input type="text" class="form-control" name="exeact_PICphone" value="<?php echo $act_PICphone;?>" required>
                            </div>

                            <div class="input-group">
                                <span class="input-group-addon">報名時間</span>
                                <input type="date" class="form-control" name="exeact_signup_starttime" value="<?php echo $act_signup_starttime;?>" required>
                                
                                <span class="input-group-addon">至</span>
                                <input type="date" class="form-control" name="exeact_signup_endtime" value="<?php echo $act_signup_endtime;?>" required>
                            </div>

                            <div class="input-group">
                                <span class="input-group-addon">活動時間</span>
                                <input type="date" class="form-control" name="exeact_starttime" value="<?php echo $act_starttime;?>" required>
                                
                                <span class="input-group-addon">至</span>
                                <input type="date" class="form-control" name="exeact_endtime" value="<?php echo $act_endtime;?>" required>
                            </div>
                            <hr>
